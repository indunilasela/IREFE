// components/SubCanalForm.jsx - SUB CANAL CREATION FORM
import React, { useState } from 'react';
import { Activity, X } from 'lucide-react';

const SubCanalForm = ({ onClose, onCreate, availableParents, availableFA, availableIrrigators }) => {
  ...
  // Debug logging for available users
  console.log('🔍 SubCanalForm - Available FA:', availableFA?.length);
  console.log('🔍 SubCanalForm - Available Irrigators:', availableIrrigators?.length);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {availableParents.length === 0 ? (
              <p className="text-xs text-red-500 mt-1">No parent canals available. Please create main canals first.</p>
            ) : (
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Selected: {formData.selectFA.length} FA(s)
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Selected: {formData.selectIrrigator.length} Irrigator(s)
            </p>
          </div>
